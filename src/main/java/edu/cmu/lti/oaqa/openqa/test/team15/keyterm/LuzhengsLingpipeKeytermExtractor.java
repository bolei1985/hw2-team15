...
public class LuzhengsLingpipeKeytermExtractor extends AbstractKeytermExtractor {
	...
	public void initialize(UimaContext c) throws ResourceInitializationException{
		...
		try {
			...
			expander = clz.getConstructor().newInstance(null);
		} catch (Exception e) {
			e.printStackTrace();
		} 
	}
...
//				      new BufferedOutputStream(new FileOutputStream("src/main/resources/output/pos.txt", true)));
...
//		// write the weight of the keyterms into a file 
//		try {
//			  	PrintStream out = new PrintStream( 
//				      new BufferedOutputStream(new FileOutputStream("src/main/resources/output/termweight.txt", true)));
//				out.println(weightList.toString());
//				out.close();
//		} catch (IOException e) {
//			// TODO Auto-generated catch block
//			e.printStackTrace();
